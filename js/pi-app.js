...
let db = require('../data/movies.json');                        // Movie database
...
fs.writeFile('../data/selected.csv', output, function(err) {    // Writing output to the csv file
...
fs.writeFile('../data/movies.json', jsonfile, function(err) {   // save db string to json database
    if(err) { console.log(err); }
});